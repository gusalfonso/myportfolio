...
const resources = {
  en: {
    translation: {
      ...
      summary:
        "My name is Gustavo, although most people know me as Tavi. I am a curious and passionate person who loves learning new things, especially when it comes to exploring innovative ideas and finding creative solutions.  As a Chemical Engineer, I worked in bioethanol production, where I specialized as a data analyst and developed models to optimize business decision-making.  I also founded Hidrovita, a company dedicated to producing leafy greens through hydroponics. This project not only promoted sustainable practices but also delivered healthy and high-quality food.  In my pursuit of continuous growth, I discovered my interest in web programming. I am currently expanding my skills in this field, aiming to combine my knowledge in data analysis and web development to create innovative solutions.",
